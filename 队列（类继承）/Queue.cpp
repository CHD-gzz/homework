...
public:
    ArrayQueue(int Capacity):Array<T>(Capacity){}
    T dequeue(){
        return Array<T>::removeFirst();
    }
    void enqueue(T e){
        Array<T>::addLast(e);
    }
    T getFront(){
        return Array<T>::getFirst();
    }
	T getTail(){
        return Array<T>::getLast();
    }
    void print(){
        cout<<"Queue:capacity="<<Array<T>::getCapacity()<<",size="<<Array<T>::getSize()<<endl;
		cout << "front[ ";
...
int main(){
    ...
    Queue.print();
    cout<<"front:"<<Queue.getFront()<<" ,tail"<<Queue.getTail()<<endl;
    Queue.dequeue();
    Queue.print();
    cout<<"front:"<<Queue.getFront()<<" ,tail"<<Queue.getTail()<<endl;
    Queue.enqueue(9);
